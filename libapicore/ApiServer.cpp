                ...
                m_message, http_matches, http_pattern, std::regex_constants::match_default))
        {
            ...
            if (http_method != "GET")
            {
                ...
                ss << http_ver << " "
                   ...
                   << "Server: " << olminer_get_buildinfo()->project_name_with_version << "\r\n"
...
Json::Value ApiConnection::getMinerStat1()
{
    ...
    jRes[0] = olminer_get_buildinfo()->project_name_with_version;  // miner version.
...
Json::Value ApiConnection::getMinerStatDetail()
{
    ...
    /* Host Info */
    Json::Value hostinfo;
    hostinfo["version"] = olminer_get_buildinfo()->project_name_with_version;  // miner version.
